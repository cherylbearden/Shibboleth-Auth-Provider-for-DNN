...
<asp:Label ID="lblShibEnabled" runat="server" Text="Shibboleth Logon"></asp:Label>
<asp:Label ID="lblShibNotEnabled" runat="server" Text="Shibboleth is not Enabled"></asp:Label>
<br />
